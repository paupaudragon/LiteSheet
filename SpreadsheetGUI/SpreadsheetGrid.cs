...
public class SpreadsheetGrid : ScrollView, IDrawable
{
    ...
    /*Commented by tzhou: 
     * 1. GraphicView is a graphics canvas for 2D drawing 
     * 2. Must define an IDrawable
     * 3 Has an Invalidate method that informs the canvas that it needs to redraw itself.
     */
    ...
    /*Commented by tzhou: 
     * 1. GraphicView has a property Drawable, and it is defined as IDrawable.
     * 2. BackgourndColor is a property of VisualElement
     */

    /* Added by Andy
     * The fields for Double-clicked event
     */
    private PointF point = new PointF(-1, -1);
