...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        //
        /// This method is try to go all variables and dependees' list of each variables, and then call the recursive of that each variables
        /// to see if any of it cause a Circle. If yes, throw CircularException()
        /// </summary>
